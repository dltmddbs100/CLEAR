...
class XQuADCrossRetrieval_EN_LANG(MultilingualTask, AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="XQuADCrossRetrieval_EN_LANG",
        dataset={
            "path": "google/xquad",
    ...
    def load_data(self, **kwargs):
        ...
        for lang in self.hf_subsets:
            ...
            data = datasets.load_dataset(
                name=f"xquad.{corpus_language}", **self.metadata_dict["dataset"]
            )[split]
