...
class BelebeleRetrieval(MultilingualTask, AbsTaskRetrieval):
    ...
    def load_data(self, **kwargs) -> None:
        ...
        self.hf_subsets.append('eng_Latn-eng_Latn')
...
#             # Sort questions to ensure consistent ID generation
#             sorted_questions = sorted(set(ds_question["question"]))
#             question_ids = {question: f"Q{i}" for i, question in enumerate(sorted_questions)}
...
#             for row in ds_question:
#                 query = row["question"]
#                 query_id = question_ids[query]  # Use the fixed ID for questions
#                 self.queries[lang_pair][_EVAL_SPLIT][query_id] = query
