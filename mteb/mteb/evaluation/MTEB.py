...
class MTEB:
    ...
    def _run_eval(
        ...
        folder_name: str | None,    # Save Folder Name
    ...
    def run(
        ...
        **kwargs,
        ...
        output_path = self.create_output_folder(meta, output_folder, folder_name)
    ...
    def create_output_folder(
        self, model_meta: ModelMeta, output_folder: str | None, folder_name: str | None
    ) -> Path | None:
        ...
        output_path = Path(output_folder) / folder_name / model_revision
